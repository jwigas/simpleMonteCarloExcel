...
function MonteCarloTriangle(xMin,xMax,yMin,yMax,numOfSamples){
    var i;
    radius = xMax - xMin;
    var samples=[];
    var outside=[];
...
radius = xMax - xMin
numOfSamples = 10000
data = MonteCarloTriangle(xMin,xMax,yMin,yMax,numOfSamples)
...
console.log("area of Triangle is :", AreaOfFunctionMC(xMin,xMax,yMin,yMax,ratio))
console.log("While the analytics result is : ",Math.PI/4*(radius)**2)

//Printed in html
document.getElementById("Values3")
    .innerHTML= "counted: " + data[0].length + " total samples: " + numOfSamples + " Ratio: " + ratio + "</br>"
                ...
                + "While the analytics result is : " + 0.5*(xMax-xMin)*(yMax-yMin);
